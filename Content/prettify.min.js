...
(function() {
    ...
    function j(e, t, n) {
        function a(e) {
            switch (e.nodeType) {
                case 1:
                    ...
                    if ("br"===e.nodeName) {
                        f(e),e.parentNode && e.parentNode.removeChild(e);
                    }
                    else {
        ...
        function f(e) {
            function t(e, n) {
                ...
                if (i) {
                    ...
                    s.appendChild(r);
                    for (var u = o;u;u=o) {
                        o=u.nextSibling,s.appendChild(u)
                    }
                }
                return r
            }
            ...
            for (var r;(r=n.parentNode) && r.nodeType===1;) {
                n = r;
            }
            u.push(n)
        }
        ...
        for (var l = 0,p = u.length;l < p;++l) {
            o=u[l],o.className="L" + (l + h) % 10,o.firstChild || o.appendChild(s.createTextNode("\u00a0")),c.appendChild(o);
        }
        e.appendChild(c)
    }
    function F(e) {
    ...
    function W(t) {
            ...
            for (;f < i.length && a.now() < n;f++) {
                ...
                if (h.test(s) && !p.test(s)) {
                    ...
                    if (!o) {
                        ...
                        T=T?T[1] && T[1].length?+T[1]:!0:!1,T && j(r, T, E),l={langExtension:b,sourceNode:r,numberLines:T,pre:E},U(l)
                    }
                }
            }
        ...
        for (var s = 0;s < r.length;++s) {
            for (var o = 0,u = r[s].length;o < u;++o) {
                i.push(r[s][o]);
            }
        }
        r = null;
        var a = Date;
        a.now||(a={now:function() {
            return+(new Date)
        }});
